...
using StickyNotes.Login.Models;

namespace StickyNotes.Login.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    // Redirección al Web
                    return Redirect(
                        $"https://localhost:44383/Account/Authenticate" +
                        $"?token={identityUser.Id}&email={HttpUtility.UrlEncode(identityUser.Email)}");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            return Redirect(
                $"https://localhost:44383/Account/Authenticate" +
                $"?token={identityUser.Id}&email={HttpUtility.UrlEncode(model.Email)}");
        }
